...
## Knowledge Corpus
- `src/shared/libs/behavioral-logic.ts` — 7 oath categories, grace days (2/month), onboarding bonus ($5), loss aversion lambda=2.0, downscale after 3 strikes, 7-day cool-off, BMI floor 18.5, 2% weekly loss velocity cap, recovery max 30 days, max 3 no-contact targets, 3 missed attestations = auto-fail
