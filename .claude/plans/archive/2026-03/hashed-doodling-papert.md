...
**RQ1.** How can loss aversion (λ=2.0) be operationalized as a calibrated penalty coefficient within a digital commitment device, and under what conditions does financially-staked behavioral contracting produce sustained habit adherence?
...
|---|-----------|-------------|---------|
| 1 | Prospect Theory / Behavioral Economics | Kahneman & Tversky 1979; Thaler 1999; Laibson 1997 | λ=2.0, endowed progress, mental accounting |
...
| `src/shared/libs/behavioral-logic.ts` | Constants, oath taxonomy, λ=2.0 |
