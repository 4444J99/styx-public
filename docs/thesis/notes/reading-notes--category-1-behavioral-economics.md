...
- Loss aversion coefficient empirically measured at λ ≈ 2.0 (later refined to 2.0 in Tversky & Kahneman 1992)
...
- λ = 2.0 is the calibration constant in `behavioral-logic.ts:LOSS_AVERSION_COEFFICIENT`
...
- Refined λ to 2.25 in experimental settings (Styx uses 2.0 as a conservative calibration)
...
1. **λ = 2.0 as design constant:** Grounded in Kahneman & Tversky (1979), refined by Tversky & Kahneman (1992), operationalized in Styx's penalty weighting
