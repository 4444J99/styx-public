...
**(f) Asymmetric Incentive:** The penalty-to-reward ratio (*β*f/*β*c = 3, *β*s/*β*c = 4) exceeds the loss aversion coefficient (*λ* = 2.0), ensuring penalties dominate rewards in perceived magnitude.
...
> *λ* · *β*f > *β*c ⟺ 2.0 · 15 > 5 ⟺ 29.33 > 5 ✓
> *λ* · *β*s > *β*c ⟺ 2.0 · 20 > 5 ⟺ 39.10 > 5 ✓

The perceived penalty-to-reward ratio is effectively:
- Fraud: *λ* · *β*f / *β*c = 2.0 · 3.0 = 5.87
- Strike: *λ* · *β*s / *β*c = 2.0 · 4.0 = 7.82
