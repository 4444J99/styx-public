...
**Styx** is a decentralized, peer-audited behavioral market focused on **relationship recovery** and the **No Contact** rule. It weaponizes **loss aversion** (using a validated coefficient of 2.0) by requiring users to stake financial deposits into behavioral contracts.
