...
Turborepo monorepo in ORGAN-III (commercial products). Promotion status: **PUBLIC_PROCESS**. 307 tests across 5 workspaces.
...
**Behavioral Logic** (`behavioral-logic.ts`): 6 oath categories (Biological, Cognitive, Professional, Creative, Environmental, Character). Constants: grace days 2/month, onboarding bonus $5, loss aversion λ=2.0, downscale after 3 strikes, 7-day cool-off, BMI floor 18.5, 2% weekly loss velocity cap.
