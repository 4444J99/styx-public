    ...
    contentBlocks: [
      {
        ...
        data: {
          items: [
            ...
            { value: '\u03BB = 2.0', label: 'Loss Aversion Coefficient', source: 'Tversky & Kahneman' },
    ...
    toughQuestions: [
      {
        ...
        answer: 'That\u2019s exactly the point. Motivation is unreliable \u2014 it\u2019s a feeling, not a system. Styx replaces motivation with mechanism. Financial loss aversion is 2.0x more powerful than reward-seeking. We don\u2019t need users to stay motivated; we need them to stay afraid of losing money.',
      },
      {
  ...
  },
  {
    ...
    contentBlocks: [
      ...
      },
      {
        ...
        data: {
          items: [
            { value: '\u03BB 2.0', label: 'Loss \u2248 2\u00D7 gain in perceived value', source: 'Prospect Theory' },
          ...
          columns: [
            ...
            },
            {
              ...
              items: [
                ...
                'Loss aversion mechanics (λ = 2.0) drive follow-through',
